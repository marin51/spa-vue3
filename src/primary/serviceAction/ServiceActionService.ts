...
import { CreateServiceActionUseCase } from './use-cases/CreateServiceActionUseCase';
import { GetServiceActionsUseCase } from './use-cases/GetServiceActionsUseCase';
...
export class ServiceActionService {
    ...
    constructor(
        ...
        this.createServiceActionUseCase = new CreateServiceActionUseCase(
    ...
    async createServiceAction(form: ServiceActionToSave) {
        return await this.createServiceActionUseCase.execute(form, form.carId);
    }
}
